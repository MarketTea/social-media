...
import 'package:kadai_app/model/message_chat.dart';
import 'package:kadai_app/providers/auth_provider.dart';
import 'package:kadai_app/providers/chat_provider.dart';
...
class ChatPage extends StatefulWidget {
  ...
  const ChatPage({Key key, this.peerId, this.peerAvatar, this.peerNickname})
      : super(key: key);
...
class _ChatPageState extends State<ChatPage> {
  _ChatPageState({this.peerId, this.peerAvatar, this.peerNickname});
