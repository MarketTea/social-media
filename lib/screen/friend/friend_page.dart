...
import 'package:kadai_app/constants/app_constants.dart';
import 'package:kadai_app/constants/color_constants.dart';
import 'package:kadai_app/constants/firestore_constants.dart';
import 'package:kadai_app/model/popup_choices.dart';
import 'package:kadai_app/model/user.dart';
import 'package:kadai_app/model/user_chat.dart';
import 'package:kadai_app/providers/auth_provider.dart';
import 'package:kadai_app/providers/friend_provider.dart';
import 'package:kadai_app/screen/chat/chat_page.dart';
import 'package:kadai_app/screen/login/login_page.dart';
import 'package:kadai_app/screen/setting/setting_page.dart';
import 'package:kadai_app/until/debounce_time.dart';
import 'package:kadai_app/until/dialogs.dart';
import 'package:kadai_app/until/utilities.dart';
...
class FriendScreen extends StatefulWidget {
  ...
  const FriendScreen({Key key, this.myData, this.updateMyData})
      : super(key: key);
...
class _FriendScreenState extends State<FriendScreen> {
  ...
  DebounceTime debounceTimeSearch = DebounceTime(milliseconds: 300);
  ...
  void registerNotification() {
    ...
    firebaseMessaging.getToken().then((token) {
      ...
      if (token != null) {
        friendProvider.updateDataFirestore(FirestoreConstants.pathUserCollection, currentUserId, {'pushToken': token});
      }
    }).catchError((err) {
  ...
  Future showNotification(RemoteNotification remoteNotification) async {
    AndroidNotificationDetails androidPlatformChannelSpecifics = AndroidNotificationDetails(
      Platform.isAndroid ? 'com.example.kadai_app' : 'com.example.kadai_app',
      'Flutter chat demo',
      playSound: true,
    ...
    print("Remote Notification: -----" + remoteNotification.title);
              ...
              children: [
                ...
                Expanded(
                  child: StreamBuilder<QuerySnapshot>(
                    stream: friendProvider.getStreamFireStore(
